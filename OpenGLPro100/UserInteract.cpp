...
void getUserInput() {
	...
	cout << "---------------" << endl;
	cout << "Albertus Kelvin" << endl << endl;
	...
	if (numSquare <= 0) {
		cout << "Input jumlah tidak valid (<=0). Jumlah square dibuat default: 1" << endl;
		numSquare = 1;
	}
	...
	if (numCircle <= 0) {
		cout << "Input jumlah tidak valid (<=0). Jumlah circle dibuat default: 1" << endl;
		numCircle = 1;
	}
	...
	if (numOctagon <= 0) {
		cout << "Input jumlah tidak valid (<=0). Jumlah octagon dibuat default: 1" << endl;
		numOctagon = 1;
	}
...
void setUserOctagon(int idx) {
	cout << "[Octagon " << idx << "]" << " - kode [0..1]" << endl;
	cout << "R: ";
	cin >> octagons[idx]->R;
